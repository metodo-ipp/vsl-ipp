...
import CidFbAdsVertical from "@/pages/cid-fb-ads-vertical";
import CidFunil from "@/pages/cid-funil";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/cid/fb-ads-vertical" component={CidFbAdsVertical} />
      <Route path="/cid/fb-ads" component={CidFbAds} />
      <Route path="/cid/funil" component={CidFunil} />
